...
export const inventoryItemSchema = z.object({
  ...
  mainItemNumber: z.string().min(1, "Nomor Induk Barang tidak boleh kosong"),
  mainItemLetter: z.string().min(1, "Huruf Induk Barang tidak boleh kosong"),
  subItemType: z.string().min(1, "Sub Jenis Barang tidak boleh kosong"),
  brand: z.string().min(1, "Merk/Tipe tidak boleh kosong"),
  subItemTypeCode: z.string().min(1, "Kode Sub Jenis Barang tidak boleh kosong"),
  subItemOrder: z.string().min(1, "Nomor Urut Sub Barang tidak boleh kosong"),

  // Pendanaan
  fundingSource: z.string().min(1, "Sumber Pendanaan tidak boleh kosong"),
  fundingItemOrder: z.string().min(1, "Nomor Urut Barang Pendanaan tidak boleh kosong"),
  
  // Lokasi
  area: z.string().min(1, "Area/Ruang tidak boleh kosong"),
  subArea: z.string().min(1, "Sub-Area/Ruang tidak boleh kosong"),

  // Pengadaan
  procurementDate: z.coerce.number().min(1).max(31),
  procurementMonth: z.coerce.number().min(1).max(12),
  procurementYear: z.coerce.number().min(1900).max(new Date().getFullYear()),
  supplier: z.string().min(1, "Supplier/Distributor tidak boleh kosong"),
